	...
	<body>
		...
		<div id="show-project" class="content scaffold-show" role="main">
			...
			<ol class="property-list project">
				...
				<g:if test="${projectInstance?.job}">
				<li class="fieldcontain">
					<span id="job-label" class="property-label"><g:message code="project.job.label" default="Job" /></span>
					
						<span class="property-value" aria-labelledby="job-label"><g:fieldValue bean="${projectInstance}" field="job"/></span>
